...
namespace FrmPrincipal
{
    public partial class frmEstacionamiento : Form
    {
        ...
        private void frmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            this.estacionamiento = Estacionamiento.GetEstacionamiento("Estacionamiento 'La recuperacion'\nDueño: Diaz Lautaro Nicolas", 20);
            this.txtEstacionamiento.Text = this.estacionamiento.Nombre;
        }
        ...
        private void cmbTipoVehiculo_SelectedIndexChanged(object sender, EventArgs e)
        {
            if ((Vehiculo.EVehiculos)this.cmbTipoVehiculo.SelectedItem == Vehiculo.EVehiculos.Automovil)
            {
                ...
                lblTipo.Text = "Marca: " + this.txtMarca.Text;
