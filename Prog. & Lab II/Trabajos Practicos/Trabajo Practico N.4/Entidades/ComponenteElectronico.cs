...
namespace Entidades
{
    ...
    public abstract class ComponenteElectronico
    {
        ...
        #region Propiedades
        /// <summary>
        /// Lectura: Retorna el ID unico del componente<br></br>
        /// Escritura: Asigna un ID si es de tipo Int32
        /// </summary>
        ...
        {
            get => this.esPotenciable;
            set => this.esPotenciable = value;
        }
        #endregion
        ...
        { }
        public ComponenteElectronico(EMarcas marca, string modelo, float potencia, float consumo, float precio, int id) : this()
        {
            this.marca = marca;
            this.modelo = modelo;
        ...
        /// <summary>
        /// Ingreso un elemento a la lista de componentes
        /// </summary>
        /// <param name="lista">Lista de componentes</param>
        /// <param name="cE">Componente a agregar</param>
        /// <returns>True si el elemento no está en la lista, de lo contrario False</returns>
        public static List<ComponenteElectronico> operator +(List<ComponenteElectronico> lista, ComponenteElectronico cE)
        {
            if (lista != cE)
            {
                lista.Add(cE);
