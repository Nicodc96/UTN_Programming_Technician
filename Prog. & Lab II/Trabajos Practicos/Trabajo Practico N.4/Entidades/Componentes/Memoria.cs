...
namespace Entidades.Componentes
{
    ...
    public class Memoria : ComponenteElectronico, IComponente<Memoria>, IBenchmark
    {
        ...
        {
            get => this.tipoDeMemoria;
            set => this.tipoDeMemoria = value;
        }
        /// <summary>
        ...
        {
            get => this.tipoDeTecnologiaMemoria;
            set => this.tipoDeTecnologiaMemoria = value;
        }
        /// <summary>
        ...
        public Memoria() : base()
        { }
        public Memoria(EMarcas marca, string modelo, float potencia, float consumo, float precio, ETipoMemoria tipoMemoria, ETecnologiaMemoria tipoTecnologia, int id)
            : base(marca, modelo, potencia, consumo, precio, id)
        {
            this.tipoDeMemoria = tipoMemoria;
            this.tipoDeTecnologiaMemoria = tipoTecnologia;
        }
        public Memoria(EMarcas marca, string modelo, float potencia, float consumo, float precio, int id)
            : this(marca, modelo, potencia, consumo, precio, ETipoMemoria.DIMM, ETecnologiaMemoria.DDR4, id)
        {
        }
        #endregion
