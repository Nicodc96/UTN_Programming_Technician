...
namespace Formularios
{
    public partial class frmModificarProducto : Form
    {
                ...
                if (this.compElectrAModificar is not null)
                {
                    switch (this.compElectrAModificar)
                    {
                        ...
                        case PlacaDeVideo:
                            ...
                            //this.cmbTipoPlaca.SelectedItem = ((PlacaDeVideo)this.compElectrAModificar).Tipo; <- BUG
        ...
        {
            if (MessageBox.Show($"¿Confirma modificar los datos del producto actual?\n\n{this.compElectrAModificar.ToString()}", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                switch(this.compElectrAModificar)
                {
                    case Disco:
