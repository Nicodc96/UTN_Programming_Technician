...
namespace Entidades
{
    ...
    public class Cliente
    {
        ...
        {
            get { return this.presupuestoPedido; }
        ...
        public Cliente()
        { }
        public Cliente(string nombre, string apellido, string documento, byte edad, Presupuesto presupuesto):this()
        {
            this.nombre = nombre;
