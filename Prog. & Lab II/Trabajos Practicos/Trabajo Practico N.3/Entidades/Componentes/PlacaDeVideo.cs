...
namespace Entidades.Componentes
{
    ...
    public class PlacaDeVideo : ComponenteElectronico, IComponente<ComponenteElectronico>, IBenchmark
    {
        ...
        { }
        public PlacaDeVideo(EMarcas marca, string modelo, float potencia, float consumo, float precio, float memoriaGrafica, ETipoPlaca tipo)
            : base(marca, modelo, potencia, consumo, precio)
        {
            this.memoriaGrafica = memoriaGrafica;
            this.tipoDePlacaGrafica = tipo;
        }
        public PlacaDeVideo(EMarcas marca, string modelo, float potencia, float consumo, float precio)
            : this(marca, modelo, potencia, consumo, precio, 1f, ETipoPlaca.IntegradaCPU)
        {
        }
        #endregion
