...
namespace Entidades.Componentes
{
    ...
    public class Procesador : ComponenteElectronico, IComponente<Procesador>, IBenchmark
    {
        ...
        public ECantidadNucleos Nucleos
        {
            get
            {
                return this.cantidadDeNucleos;
            }
            set
            {
                this.cantidadDeNucleos = value;
            }
        }
        /// <summary>
        ...
        public override bool Potenciable
        {
            get
            {
                return this.EsOvercockleable(this);
            }
        }
        #endregion
        ...
        { }
        public Procesador(EMarcas marca, string modelo, float potencia, float consumo, float precio, EFabricanteCPU fabricante, ECantidadNucleos cantNucleos)
            : base(marca, modelo, potencia, consumo, precio)
        {
            this.nombreFabricante = fabricante;
            this.cantidadDeNucleos = cantNucleos;
        }
        public Procesador(EMarcas marca, string modelo, float potencia, float consumo, float precio) 
            : this(marca, modelo, potencia, consumo, precio, EFabricanteCPU.AMD, ECantidadNucleos.Quad_Core)
        {
        }
        #endregion
