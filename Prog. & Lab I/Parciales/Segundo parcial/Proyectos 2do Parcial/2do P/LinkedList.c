...
/** \brief Mapea los elementos del Linkedlist recibido como parametro y devuelve
 *         una nueva lista con los elementos mapeados.
 * \param LinkedList* this      | Lista Original
 * \param void (*pFunc)(void*)   | Funcion mapeadora
 * \return LinkedList* newList    -   NULL Error: Si la lista o la función devuelve NULL
 *                                          LinkedList* La lista mapeada
 */
