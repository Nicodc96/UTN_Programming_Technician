...
namespace Entidades.Componentes
{
    ...
    public class FuenteDePoder : ComponenteElectronico, IComponente<FuenteDePoder>, IBenchmark
    {
        ...
        {
            get => this.tipoDeFuente;
            set => this.tipoDeFuente = value;
        }
        #endregion
        ...
        { }
        public FuenteDePoder(EMarcas marca, string modelo, float potencia, float consumo, float precio, ETipoFuente tipo, int id)
            : base(marca, modelo, potencia, consumo, precio, id)
        {
            this.tipoDeFuente = tipo;
        }
        public FuenteDePoder(EMarcas marca, string modelo, float potencia, float consumo, float precio, int id)
            : this(marca, modelo, potencia, consumo, precio, ETipoFuente.ATX, id)
        {
        }
        #endregion
