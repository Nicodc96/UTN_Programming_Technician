...
namespace Entidades.Componentes
{
    ...
    public class Disco : ComponenteElectronico, IComponente<Disco>, IBenchmark
    {
        ...
        public short EspacioTotal
        {
            get
            {
                return this.cantidadDeEspacio;
            }
            set
            {
                this.cantidadDeEspacio = value;
            }
        }
        /// <summary>
        ...
        public Disco():base()
        {}
        public Disco(EMarcas marca, string modelo, float potencia, float consumo, float precio, short cantidadEspacio, ETipoDisco tipo)
            : base(marca, modelo, potencia, consumo, precio)
        {
            this.cantidadDeEspacio = cantidadEspacio;
            this.tipoDeDisco = tipo;
        }
        public Disco(EMarcas marca, string modelo, float potencia, float consumo, float precio)
            : this(marca, modelo, potencia, consumo, precio, 256, ETipoDisco.HDD)
        {
        }
        #endregion
