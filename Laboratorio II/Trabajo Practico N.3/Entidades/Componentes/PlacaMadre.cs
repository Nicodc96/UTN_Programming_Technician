...
namespace Entidades.Componentes
{
    ...
    public class PlacaMadre : ComponenteElectronico, IComponente<PlacaMadre>, IBenchmark
    {
        ...
        public ETipoMother TipoDeMother
        {
            get
            {
                return this.tipoDePlacaMadre;
            }
            set
            {
                this.tipoDePlacaMadre = value;
            }
        }
        /// <summary>
        ...
        public ESocket Socket
        {
            get
            {
                return this.tipoDeSocket;
            }
            set
            {
                this.tipoDeSocket = value;
            }
        }
        /// <summary>
        ...
        { }
        public PlacaMadre(EMarcas marca, string modelo, float potencia, float consumo, float precio, ETipoMother tipoMother, ESocket tipoSocket)
            : base(marca, modelo, potencia, consumo, precio)
        {
            this.tipoDePlacaMadre = tipoMother;
            this.tipoDeSocket = tipoSocket;
        }
        public PlacaMadre(EMarcas marca, string modelo, float potencia, float consumo, float precio)
            : this(marca, modelo, potencia, consumo, precio, ETipoMother.Normal, ESocket.AM4)
        {
        }
        #endregion
