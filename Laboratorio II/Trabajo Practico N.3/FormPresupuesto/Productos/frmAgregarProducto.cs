...
{    
    public partial class frmAgregarProducto : Form
    {
        ...
        public List<ComponenteElectronico> ListaInterna
        {
            set
            {
                this.listaComponentesActual = value;
            }
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (this.cmbMarcas.SelectedItem is null || string.IsNullOrEmpty(this.txBModelo.Text) || string.IsNullOrEmpty(this.txBPotencia.Text) || string.IsNullOrEmpty(this.txBConsumo.Text) || string.IsNullOrEmpty(this.txBPrecio.Text))
                {
                ...
                } else
                {
                    ...
                    {
                        case "Disco":
                            if (this.cmbTipoDisco.SelectedItem is null || string.IsNullOrEmpty(this.txtTamanioDisco.Text))
                            {
                                this.componenteNuevo = new Disco((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));                                
                            } else
                            {
                                this.componenteNuevo = new Disco((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), short.Parse(this.txtTamanioDisco.Text), (ETipoDisco)this.cmbTipoDisco.SelectedItem);
                            }
                        ...
                        case "FuenteDePoder":
                            ...
                            {
                                this.componenteNuevo = new FuenteDePoder((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));
                            } else
                            {
                                this.componenteNuevo = new FuenteDePoder((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), (ETipoFuente)this.cmbTipoFuente.SelectedItem);
                            }
                            AgregandoComponente(this.componenteNuevo);
                            break;
                        case "Memoria":
                            ...
                            {
                                this.componenteNuevo = new Memoria((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));
                            } else
                            {
                                this.componenteNuevo = new Memoria((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), (ETipoMemoria)this.cmbTipoMemoria.SelectedItem, (ETecnologiaMemoria)this.cmbGeneracion.SelectedItem);
                            }
                            AgregandoComponente(this.componenteNuevo);
                            break;
                        case "PlacaDeVideo":
                            if (this.cmbTipoPlaca.SelectedItem is null || string.IsNullOrEmpty(this.txBMemoriaGrafica.Text))
                            {
                                this.componenteNuevo = new PlacaDeVideo((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));
                            } else
                            {
                                this.componenteNuevo = new PlacaDeVideo((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), float.Parse(this.txBMemoriaGrafica.Text), (ETipoPlaca)this.cmbTipoPlaca.SelectedItem);
                            }
                            AgregandoComponente(this.componenteNuevo);
                            break;
                        case "PlacaMadre":
                            ...
                            {
                                this.componenteNuevo = new PlacaMadre((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));
                            } else
                            {
                                this.componenteNuevo = new PlacaMadre((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), (ETipoMother)this.cmbTipoMother.SelectedItem, (ESocket)this.cmbSocket.SelectedItem);
                            }
                            AgregandoComponente(this.componenteNuevo);
                            break;
                        case "Procesador":
                            ...
                            {
                                this.componenteNuevo = new Procesador((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text));
                            } else
                            {
                                this.componenteNuevo = new Procesador((EMarcas)this.cmbMarcas.SelectedItem, this.txBModelo.Text, float.Parse(this.txBPotencia.Text), float.Parse(this.txBConsumo.Text), float.Parse(this.txBPrecio.Text), (EFabricanteCPU)this.cmbFabricanteCPU.SelectedItem, (ECantidadNucleos)this.cmbCantNucleos.SelectedItem);
                            }
                            AgregandoComponente(this.componenteNuevo);
                            break;
                    }
        ...
        {
            if (this.listaComponentesActual == comp)
            {
                MessageBox.Show("El producto ya existe en la base de datos!", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
